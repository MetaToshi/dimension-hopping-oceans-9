...
var resource = load("res://Dialogue/EXPOSITION.dialogue")
...
func _ready():
	DialogueManager.show_example_dialogue_balloon(load("res://Dialogue/EXPOSITION.dialogue"), "this_is_a_node_title")
